...
class Tag
{
    ...
    #[ORM\OneToMany(mappedBy: 'tag', targetEntity: RecipeHasIngredient::class)]
    ...
    public function addRecipeHasIngredient(RecipeHasIngredient $recipeHasIngredient): self
    {
        if (!$this->recipeHasIngredients->contains($recipeHasIngredient)) {
            ...
            $recipeHasIngredient->setTag($this);
        }
    ...
    public function removeRecipeHasIngredient(RecipeHasIngredient $recipeHasIngredient): self
    {
        if ($this->recipeHasIngredients->removeElement($recipeHasIngredient)) {
            ...
            if ($recipeHasIngredient->getTag() === $this) {
                $recipeHasIngredient->setTag(null);
            }
        }
